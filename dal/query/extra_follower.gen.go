...
func (e extraFollowerDo) InsertFollower(uid int64) (err error) {
	...
	generateSQL.WriteString("insert into extra_follower (uid) values (?) ")
...
func (e extraFollowerDo) DeleteFollower(uid int64) (err error) {
	...
	var generateSQL strings.Builder
	params = append(params, uid)
	generateSQL.WriteString("insert into extra_follower (uid, stats) values (?, 1) ")
...
func (e extraFollowerDo) FindUnSyncRecord(limit int64) (result []*model.ExtraFollower, err error) {
	...
	generateSQL.WriteString("select id, uid, stats from extra_follower limit ? ")
...
func (e extraFollowerDo) FindUnSyncRecordByUID(uid int64, limit int64) (result []*model.ExtraFollower, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, uid)
	params = append(params, limit)
	generateSQL.WriteString("select id, uid, stats from extra_follower where uid=? limit ? ")
...
func (e extraFollowerDo) DeleteRecord(ids []int64) (err error) {
	...
	generateSQL.WriteString("delete from extra_follower where id in (?) ")
