...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.UID = field.NewInt64(tableName, "uid")
	_follow.FollowUID = field.NewInt64(tableName, "follow_uid")
	_follow.Ctime = field.NewTime(tableName, "ctime")
	_follow.Mtime = field.NewTime(tableName, "mtime")
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.FollowUID = field.NewInt64(table, "follow_uid")
...
func (f *follow) fillFieldMap() {
	...
	f.fieldMap["follow_uid"] = f.FollowUID
...
func (f followDo) InsertFollow(uid int64, touid int64) (err error) {
	...
	generateSQL.WriteString("insert into follow (uid, follow_uid) values (?, ?) ")
