...
func newFollower(db *gorm.DB, opts ...gen.DOOption) follower {
	...
	_follower.UID = field.NewInt64(tableName, "uid")
	_follower.FollowerUID = field.NewInt64(tableName, "follower_uid")
	_follower.Ctime = field.NewTime(tableName, "ctime")
	_follower.Mtime = field.NewTime(tableName, "mtime")
...
func (f *follower) updateTableName(table string) *follower {
	...
	f.FollowerUID = field.NewInt64(table, "follower_uid")
...
func (f *follower) fillFieldMap() {
	...
	f.fieldMap["follower_uid"] = f.FollowerUID
...
func (f followerDo) InsertFollower(uid int64, touid int64) (err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, uid)
	params = append(params, touid)
	generateSQL.WriteString("insert into follower (uid, follower_uid) values (?, ?) ")
...
func (f followerDo) DeleteFollower(uid int64, touid int64) (err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, uid)
	params = append(params, touid)
	generateSQL.WriteString("delete from follower where uid=? and follower_uid=? limit 1 ")
