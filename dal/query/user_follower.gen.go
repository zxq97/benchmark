...
func newUserFollower(db *gorm.DB, opts ...gen.DOOption) userFollower {
	...
	_userFollower.FollowerUID = field.NewInt64(tableName, "follower_uid")
	_userFollower.Ctime = field.NewTime(tableName, "ctime")
	_userFollower.Mtime = field.NewTime(tableName, "mtime")
...
func (u *userFollower) updateTableName(table string) *userFollower {
	...
	u.FollowerUID = field.NewInt64(table, "follower_uid")
...
func (u *userFollower) fillFieldMap() {
	...
	u.fieldMap["follower_uid"] = u.FollowerUID
...
// sql(insert into user_follower (uid, follower_uid) values (@uid, @touid))
func (u userFollowerDo) InsertFollower(uid int64, touid int64) (err error) {
	...
	generateSQL.WriteString("insert into user_follower (uid, follower_uid) values (?, ?) ")
...
// sql(delete from user_follower where uid=@uid and follower_uid=@touid limit 1)
func (u userFollowerDo) DeleteFollower(uid int64, touid int64) (err error) {
	...
	params = append(params, uid)
	params = append(params, touid)
	generateSQL.WriteString("delete from user_follower where uid=? and follower_uid=? limit 1 ")
